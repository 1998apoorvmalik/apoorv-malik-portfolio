...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Developed a linear time algorithm for RNA alignments, supporting calculations for partition function, base pairing probabilities, secondary structure predictions (MFE, MEA, Threshknot), and stochastic sampling of structures.}
         \resumeItem{Developing efficient algorithms related to RNA secondary structures prediction, and refactoring existing codebases by adding new features to enhance performance and scalability.}
        \resumeItem{Developed \href{https://linearfold.eecs.oregonstate.edu}{\underline{6 web servers}} hosting various RNA algorithms, and optimized existing web applications leading to improved SEO, and a 500\% increase in traffic, thereby enhancing the accessibility of our scientific tools.}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      {Dept. of Computer Science at Oregon State University}{Corvallis, OR, USA}
      \resumeItemListStart
          \resumeItem{Taught key concepts in Algorithms and Theory of Computation, including Complexity Analysis, Divide \& Conquer strategies, Greedy \& Graph Algorithms, Dynamic Programming, Grammar, and Turing Machines, which substantially improved students' understandings.}
  ...
  \resumeItemListStart
    ...
    \resumeItem{Liang Huang, Otso Barron, \textbf{Apoorv Malik}, Sizhen Li, David H. Mathews. \textcolor{RoyalBlue}{Lazy Outside and Lazy Backward Algorithms}. In submission to ISMB 2024 (International Society for Computational Biology). }
...
\section{Projects}
    \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          {\underline{GitHub Link}} $|$ \href{https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4713278}{\underline{SSRN Preprint Link}}} {November 2023}
